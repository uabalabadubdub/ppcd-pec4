...
print(f"How many tracks were published in the nineties: {nineties_album_tracks}")
...
print(f"What's the most popular track of the last 10 years: {last10years_most_pop_tracks.values}")
...
print(f"Which artists have at least one track for each decade since 1960: {most_prolifict_artist_since1960}")

print("\nAudio feature analysis:")
metallica_basic_stats = fa.feature_basic_statistics(df, "energy", artist_filter="Metallica")
print(f"Metallica tracks energy feature min, max and average: {metallica_basic_stats}")
